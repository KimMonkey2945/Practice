package com.totti.yongstargram.config;
...
import com.totti.yongstargram.common.PermissionInterceptor;
...
public class WebMVCConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		.excludePathPatterns("/static/**", "/images/**", "/user/signOut"); // 제외할 path
	}
