...
<body>
	...
	<div id="loginView">
		<div class="d-flex justify-content-center mt-3">
			...
			<div class="ml-5">
				<div class="login">
					<h1 class="yongstarLogo text-center">MonKeys</h1>
					<div class="d-flex justify-content-center">
						<div>
							...
							<div class="text-center">아이디/비밀번호 잊으셨나요??</div>
						</div>
					</div>
				</div>
				<div class="mt-3 d-flex content2 align-items-center justify-content-center">
					계정이 없으신가요? 
					<a class="ml-2" href="/user/signup_view">가입하기</a>
				</div>
	...
	<script>
		$(document).ready(
				function() {
					...
					var loginBannerList = [ "/static/images/loginBanner1.png",
							"/static/images/loginBanner2.png",
							"/static/images/loginBanner3.png" ]
					var currentImageIndex = 0;

					setInterval(function() {
						$("#loginImg").attr("src",
								loginBannerList[currentImageIndex]);
						currentImageIndex++;
