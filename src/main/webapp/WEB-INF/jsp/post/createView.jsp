	...
	<div>
		...
		<section class="d-flex justify-content-center">
			<div class="createPost">
				...
				<div
					class="createHeader d-flex justify-content-around align-items-center">
					<a href="/post/listView"><img class="backArrow" alt="뒤로가기화살표"
						src="/static/images/arrow.png" /></a>
					<h2>새 게시물 만들기</h2>
					<h3>공유하기</h3>
				</div>
				...
				<div class="d-flex">
					...
					<div class="ml-3">
						<div class="mb-5">여기에 로그인사람 아이디랑 프로필사진이들어갑니다.</div>
						<textarea id="textBox" class="postText" maxlength="300"
